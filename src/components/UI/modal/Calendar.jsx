    ...
    return (
        <div className="calendar">
            <div className="header">
                <button className="navButton" onClick={() => handleMonthChange(-1)}>
                    {"<"}
                </button>
                <div className="monthYear" onClick={handleYearClick}>
            ...
            <hr/>
            <button className="doneButton" onClick={handleDoneClick}>Готово</button>
        </div>
    );
};
